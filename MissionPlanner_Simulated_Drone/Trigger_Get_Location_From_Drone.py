...
class GPSListener:
    def __init__(self, connection_string='tcp:127.0.0.1:5762', sample_rate_hz=1.0):
        ...
        self.sample_interval = 1.0 / sample_rate_hz  # Convert sample rate to sample period in seconds
    ...
    def listen(self):
        ...
        try:
            while True:
                ...
                # Print armed status (0 = disarmed, 128 = armed)
                # print("Armed?: ", self.master.motors_armed())
                if self.master.motors_armed():
                    print("Drone is ARMED - takeoff possible")
                else:
                    print("Drone is DISARMED - takeoff not possible")
